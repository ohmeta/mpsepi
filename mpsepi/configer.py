...
class mpseconfig:
    ...
    def __init__(self, work_dir):
        ...
        self.mpsepi_dir = os.path.dirname(os.path.abspath(__file__))

        self.config_file = os.path.join(self.mpsepi_dir, "config", "config.yaml")
        self.envs_dir = os.path.join(self.mpsepi_dir, "envs")
        self.profiles_dir = os.path.join(self.mpsepi_dir, "profiles")
...
▐░▌       ▐░▌▐░▌          ▐░░░░░░░░░░░▌▐░░░░░░░░░░░▌▐░▌          ▐░░░░░░░░░░░▌
 ▀         ▀  ▀            ▀▀▀▀▀▀▀▀▀▀▀  ▀▀▀▀▀▀▀▀▀▀▀  ▀            ▀▀▀▀▀▀▀▀▀▀▀ 
      ...
      A microbiome analysis project has been created at %s
...
""" % (
    ...
    def create_dirs(self):
        ...
        for sub_dir in mpseconfig.sub_dirs:
